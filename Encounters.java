...
//=================================================First encounter===========================================================
      if(deciderEncounter == 0) {
         ...
         System.out.println("(2) Magic! Burn the webs!");
...
//==================================================Encounter 2====================================================================
      if(deciderEncounter == 1) {
         ...
         //Choice time.
         System.out.println("(1) Use Sword to kill the slimy thing! (Require Sword Dmg 3)");
         System.out.println("(0) Do nothing. Sucks for you.");
    ...
    if(deciderEncounter == 3) {
         ...
         if(choice==1) {
            if(Application.probabilityCalculator(0.60)) {
               ...
               System.out.println("Stumbling out of the room you do make it. Just don't go back to that room"); 
            }
         }
